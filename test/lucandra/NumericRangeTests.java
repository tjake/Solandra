...
public class NumericRangeTests {
    ...
    public static void writeIndexes() throws CorruptIndexException, IOException {
        ...
        writer.addDocument(first, analyzer, docId.incrementAndGet());
        writer.addDocument(second, analyzer, docId.incrementAndGet());
        writer.addDocument(third, analyzer, docId.incrementAndGet());
