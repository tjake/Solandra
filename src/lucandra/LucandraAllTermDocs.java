      ...
      private void getMoreDocs(){
          ...
          do{
              ...
              for(int i=doc; i<(doc+docBuffer.length) && i < maxDoc; i++){              
                  ...
                  //readCommands.add(new SliceByNamesReadCommand(CassandraUtils.keySpace, key, columnParent, Arrays.asList(CassandraUtils.delimeterBytes)));
              }
              ...
              for(Row row : rows){
                  ...
                  String docHex = key.substring(key.indexOf(CassandraUtils.delimeter) + CassandraUtils.delimeter.length());
