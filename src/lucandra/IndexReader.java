...
//    }
    ...
    public Document document(int docNum, FieldSelector selector) throws CorruptIndexException, IOException {
        ...
        try {
            Map<ByteBuffer, List<ColumnOrSuperColumn>> docMap = context.getClient().multiget_slice(Arrays.asList(keyMap.keySet().toArray(new ByteBuffer[]{})), columnParent, slicePredicate, ConsistencyLevel.ONE);
